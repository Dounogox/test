...
class AssistantGUI:
    def __init__(self, root):
        ...
        self.text_area.tag_configure("shorekeeper", justify='left', foreground="black")
    ...
    def add_shorekeeper_message(self, message): self._add_message(message, "shorekeeper")
    ...
    def process_input(self, event=None):
        ...
        for line in self.processor.process_command_text(cmd).splitlines():
            ...
            if line: self.add_shorekeeper_message(line)
